...
function DeleteUserModal({ userId }) {
  ...
  return (
    <div>
      <div className="w-[4%] text-[#004064]" onClick={() => setShowModal(true)}>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-4xl lg:min-w-[600px]">
              ...
              <div className="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="p-10">
                  ...
                  user?
                  <div className="text-gray-300 text-center text-sm pt-10">This will cause a reload of this page</div>
                </div>
                <div className="flex justify-center space-x-5 pb-10">
                  <button className="bg-[#004064] px-8 py-2 text-white rounded" onClick={()=>deleteUser(userId)}>Yes</button>
                  <button className="bg-white px-8 py-2 text-[#004064] rounded border border-[#004064]" onClick={()=>setShowModal(false)}>No</button>
                </div>
              </div>
            </div>
          </div>
